...
Este proyecto es una página web de e-commerce para una tienda de vinilos. Permite explorar un catálogo de discos, agregarlos a un carrito de compras dinámico, leer reseñas de clientes y enviar un mensaje por un formulario de contacto, aplicando **HTML5**, **CSS3** y **JavaScript**.

## Propósito
La página fue creada para ofrecer una experiencia visual "retro-moderna", facilitando a los usuarios la exploración de álbumes clásicos y modernos, la compra simulada de vinilos y un diseño responsivo que se adapta a computadoras y dispositivos móviles.
...
- **Pantalla de catálogo completo:** Una pantalla aparte (con su propio header) que muestra todos los vinilos disponibles más una sección de álbumes traídos en vivo desde una API externa.
